                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-primary text-white text-sm rounded-md shadow-md hover:bg-primary/90 transition-colors"
                            >
                                Get Started
                            </button>
                        </div>
                ...
                <div className="md:hidden bg-white/95 backdrop-blur-md border-b border-gray-100">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <button
                            ...
                            className="w-full text-left px-4 py-2 bg-primary text-white text-sm shadow-md mt-4 ml-3 rounded-md hover:bg-primary/90"
                        >
                            Get Started
                        </button>
                    </div>
