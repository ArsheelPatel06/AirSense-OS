...
class PollutionPredictionModel:
    ...
    def predict(self, current_pm25, hour_of_day, gas_index=0, fan_speed=0):
        ...
        # Add micro-variance to ensure user sees a "prediction" different from current
        # Real sensors/predictions rarely match exactly 40.0 == 40.0
        import random
        variance = random.uniform(-2, 3) # Skew slightly + for "caution"
        prediction += variance
